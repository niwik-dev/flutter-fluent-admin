...
part 'p_calendar_view.g.dart';

@swidget
Widget pageCalendarView(BuildContext context){ 
  return Placeholder();
}

ResponsiveColumn buildPageCalendarViewInColumn(BuildContext context){ 
